  ...
  return ( 
    auth?(
        ...
        {profileView && <UserOffcanvas data={allUsers} profileView={profileView} 
                ...
                logged={auth}  
        />}
        <div className='col-lg-3 kkk order-1 bg-dark' style={{'color': 'white'}}>hello</div>
        ...
        <div className="d-flex" >
            ...
            <div className="col-lg-8 d-flex flex-fill flex-column followers flex-wrap" style={{'minHeight': '60vh'}}>
                ...
                <div className='flex-fill p-4 d-flex flex-column bg-light'>
                    ...
                    <div className='flex-fill bg-white all_users p-3' style={{'minHeight': '50vh'}} >
